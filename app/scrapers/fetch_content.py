...
if __name__ == "__main__":
    async def main():
        ...
        test_url = "https://www.zh.ch/de/politik-staat/recherche-im-staatsarchiv.html"  # Ersetzen Sie dies durch die gewünschte URL
        ...
        if 'error' in result:
            ...
            output_file = "../static/cache/output_optimiert.json"
